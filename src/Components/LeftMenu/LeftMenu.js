...
import myCV from "../../Assets/media/abdumajid_cv.pdf";
    ...
    <div className="leftMenu">
      <div className="leftMenu_Top">
        ...
        <div className="wrapper_social_links">
          <a className="social_links" href="https//facebook.com">
      ...
      <div className="overlfow">
        <div className="leftMenu_info">
          <ul className="Info_list">
            ...
            <li className="Info_list-item">
              <span className="key">Residence:</span>
              <span className="value">UZ</span>
            </li>
            <li className="Info_list-item">
              <span className="key">Freelance:</span>
              <span className="value aviable">Available</span>
            </li>
            <li className="Info_list-item">
              <span className="key">Address:</span>
              <span className="value"> Tashkent, Uzbekistan</span>
            </li>
          </ul>
          <hr className="hr"></hr>
        </div>
        <div className="languages_section">
          ...
          <div className="language">
            <p>
              <span className="language_name">Uzbek</span>
          ...
          <div className="language">
            <p>
              <span className="language_name">English</span>
          ...
          <div className="language">
            <p>
              <span className="language_name">Russian</span>
        ...
        <div className="languages_section skills">
          ...
          <div className="language">
            <p>
              <span className="language_name">ReactJS</span>
              <span className="percentage">60%</span>
            </p>
            <ProgressBar variant="warning" now={60} />
          </div>
          <div className="language">
            <p>
              <span className="language_name">NodeJS</span>
        ...
        <div className="extraSkills">
          ...
          <ul className="extraSkills_list">
            <li className="extraSkills_list-item">
              <img alt="logo" src={logoExtra}></img> Bootstrap, Materialize
            </li>
            <li className="extraSkills_list-item">
              <img alt="logo" src={logoExtra}></img> Stylus, Sass, Less
            </li>
            <li className="extraSkills_list-item">
              <img alt="logo" src={logoExtra}></img> Gulp, Webpack
            </li>
            <li className="extraSkills_list-item">
              <img alt="logo" src={logoExtra}></img> GIT Knowledge
            </li>
            <li className="extraSkills_list-item">
              <img alt="logo" src={logoExtra}></img> Mongoose, ExpressJS,
              MongoDB
            </li>
          </ul>
        </div>
      ...
      <div className="btnWrapp">
        <hr className="hr"></hr>
        <a href={myCV} download className="btnDownload">
